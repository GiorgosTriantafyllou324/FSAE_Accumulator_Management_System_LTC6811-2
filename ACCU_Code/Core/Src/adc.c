...
/* USER CODE BEGIN 0 */
volatile uint32_t adc_counter, adcVal1, adcVal2, adcVal3;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOA, TEMP_DCDC_Pin|StonPatoSouGiorgo_Pin|HUMIDITY_Pin);
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef *hadc)
{
	...
	else
	{
		...
		/* NTC used for the temp measurement of the DC-DC: NXFS15XH103FEAB025 */
